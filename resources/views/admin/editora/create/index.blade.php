...
@section('titulo', 'Cadastro de Editoras')
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.editora.store') }}" method="post" enctype="multipart/form-data">
    ...
    @if (session('editora.create.success'))
        <script>
            Swal.fire({
                icon: 'success',
    ...
    @if (session('editora.create.error'))
        <script>
            Swal.fire({
                icon: 'error',
