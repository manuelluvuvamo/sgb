...
@section('titulo', 'Cadastro de Autor')
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Autor</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.autor.store') }}" method="post" enctype="multipart/form-data">
    ...
    @if (session('autor.create.success'))
        <script>
            Swal.fire({
                icon: 'success',
