...
@section('titulo', 'Pesquisa de Emprestimos')
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.emprestimo.index') }}" method="get" enctype="multipart/form-data" class="row">
                            @csrf
                                ...
                                <select name="id_professor" id="id_professor" class="form-control ">
                                    ...
                                    @foreach ($professors as $professor)
                                        <option value="{{ $professor->id }}">
                                            {{ $professor->primeiro_nome." ".$professor->sobrenome }}
                                        </option>
                                    @endforeach
                                </select>
