...
@section('titulo', 'Edição de Registros de Leitura')
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.leitura.update', $leitura->id) }}" method="post"
    ...
    {{-- leitura --}}
    @if (session('leitura.update.success'))
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Registro de Leitura Editado Com Sucesso!',
                timer: 4e3,
                timerProgressBar: !0,
                didOpen: function() {
    ...
    @if (session('leitura.update.error'))
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Erro ao Editar Registro de Leitura!',
                timer: 4e3,
                timerProgressBar: !0,
                didOpen: function() {
                    Swal.showLoading(), t = setInterval(function() {
