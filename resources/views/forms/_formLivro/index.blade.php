<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="js-example-basic-single form-select @error('id_categoria') is-invalid @enderror"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="js-example-basic-single form-select @error('id_editora') is-invalid @enderror"
